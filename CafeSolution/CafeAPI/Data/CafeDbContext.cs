...
namespace CafeAPI.Data
{
    public class CafeDbContext(DbContextOptions<CafeDbContext> options) : DbContext(options)
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                {1, 450}, {2, 350}, {3, 420}, {4, 480}, {5, 450}, {6, 400}, {7, 350}, {8, 700}, {9, 400}, {10, 1500},
                {11, 950}, {12, 1050}, {13, 650}, {14, 750}, {15, 850}, {16, 700}, {17, 650}, {18, 950}, {19, 400}, {20, 420},
                {21, 450}, {22, 250}, {23, 150}, {24, 200}, {25, 250}, {26, 220}, {27, 230}, {28, 100}, {29, 90}, {30, 80}
            };
