...
namespace CafeAPI.Data
{
    public class CafeDbContext(DbContextOptions<CafeDbContext> options) : DbContext(options)
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Indigriend>()
            ...
            modelBuilder.Entity<MenuItem>().HasData(
                new MenuItem { MenuItemId = 1, Name = "Борщ", Description = "Классический борщ с мясом, свеклой и сметаной", Price = 450, CategoryId = 1, Available = true },
                ...
                new MenuItem { MenuItemId = 26, Name = "Рис с овощами", Description = "Отварной rice с овощами", Price = 220, CategoryId = 9, Available = true },
            ...
            modelBuilder.Entity("MenuItemTag").HasData(
                new { MenuItemsMenuItemId = 2, TagsTagId = 3 }, new { MenuItemsMenuItemId = 3, TagsTagId = 2 },
                new { MenuItemsMenuItemId = 4, TagsTagId = 3 }, new { MenuItemsMenuItemId = 5, TagsTagId = 2 },
                new { MenuItemsMenuItemId = 6, TagsTagId = 2 }, new { MenuItemsMenuItemId = 6, TagsTagId = 5 },
                new { MenuItemsMenuItemId = 7, TagsTagId = 2 }, new { MenuItemsMenuItemId = 8, TagsTagId = 3 },
                new { MenuItemsMenuItemId = 9, TagsTagId = 2 }, new { MenuItemsMenuItemId = 10, TagsTagId = 3 },
                new { MenuItemsMenuItemId = 10, TagsTagId = 4 }, new { MenuItemsMenuItemId = 11, TagsTagId = 3 },
                new { MenuItemsMenuItemId = 12, TagsTagId = 3 }, new { MenuItemsMenuItemId = 13, TagsTagId = 2 },
                new { MenuItemsMenuItemId = 14, TagsTagId = 1 }, new { MenuItemsMenuItemId = 14, TagsTagId = 3 },
                new { MenuItemsMenuItemId = 15, TagsTagId = 2 }, new { MenuItemsMenuItemId = 16, TagsTagId = 3 },
                new { MenuItemsMenuItemId = 17, TagsTagId = 2 }, new { MenuItemsMenuItemId = 18, TagsTagId = 4 },
                new { MenuItemsMenuItemId = 19, TagsTagId = 2 }, new { MenuItemsMenuItemId = 20, TagsTagId = 2 },
                new { MenuItemsMenuItemId = 21, TagsTagId = 2 }, new { MenuItemsMenuItemId = 25, TagsTagId = 2 },
                new { MenuItemsMenuItemId = 25, TagsTagId = 5 }, new { MenuItemsMenuItemId = 26, TagsTagId = 2 },
                new { MenuItemsMenuItemId = 26, TagsTagId = 5 }, new { MenuItemsMenuItemId = 27, TagsTagId = 2 },
                new { MenuItemsMenuItemId = 27, TagsTagId = 5 }, new { MenuItemsMenuItemId = 28, TagsTagId = 1 }
            );
            ...
            modelBuilder.Entity<Indigriend>().HasData(
                ...
                new Indigriend { Id = 17, Name = "МакаронныеИзделия" }, new Indigriend { Id = 18, Name = "Картофель" },
                new Indigriend { Id = 19, Name = "ЛукРепчатый" }, new Indigriend { Id = 20, Name = "Морковь" },
                new Indigriend { Id = 21, Name = "Капуста" }, new Indigriend { Id = 22, Name = "Свекла" },
                new Indigriend { Id = 23, Name = "ХлебПшеничный" }, new Indigriend { Id = 24, Name = "ХлебРжаной" },
            ...
            var firstNames = new[] { "Александр", "Сергей", "Дмитрий", "Алексей", "Максим", "Андрей", "Иван", "Евгений", "Михаил", "Артем", "Анна", "Елена", "Мария", "Ольга", "Татьяна", "Наталья", "Юлия" };
            var lastNames = new[] { "Иванов", "Петров", "Смирнов", "Сергеев", "Волков", "Кузнецов", "Попов", "Васильев", "Соколов", "Новиков", "Морозов", "Козлов" };
            
            var startUserId = 10; 
            
            for (int i = 1; i <= 50; i++)
            {
                var fullName = $"{lastNames[random.Next(lastNames.Length)]} {firstNames[random.Next(firstNames.Length)]} №{i}";
                allUsers.Add(new User
                {
                    UserId = startUserId++,
                    FullName = fullName,
                    Login = $"waiter_demo_{i}",
            ...
            var startOrderId = 200; 
            for (int i = 1; i <= 250; i++)
            {
                var randomWaiter = allUsers[random.Next(1, allUsers.Count)]; 
                
                var orderDate = new DateTime(2026, 6, 1, 0, 0, 0, DateTimeKind.Utc)
                    .AddDays(random.Next(15)) 
                ...
                initialOrders.Add(new Order
                {
                    ...
                    UserId = randomWaiter.UserId,
                    TableNumber = random.Next(1, 25),
                    Status = "Оплачен",
                    CreatedAt = orderDate
                });
