...
namespace CafeClient.Pages
{
    public partial class MenuPage : Page, INotifyPropertyChanged
    {
        ...
        private async Task LoadCategories()
        {
            try
            {
                Categories = await _apiService.GetCategoriesAsync() ?? throw new InvalidOperationException();
            }
            catch (Exception ex)
            {
        ...
        private async void AddMenuItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show("Пожалуйста, заполните Название, выберите Категорию и укажите Цену!", "Внимание",
            ...
            {
                MessageBox.Show("Название блюда должно содержать только буквы!", "Ошибка валидации",
        ...
        private async void DeleteMenuItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                var result = MessageBox.Show($"Удалить '{item.Name}' из меню?", "Подтверждение", MessageBoxButton.YesNo,
